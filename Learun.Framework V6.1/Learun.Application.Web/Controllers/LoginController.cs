...
namespace Learun.Application.Web.Controllers
{
    ...
    public class LoginController : MvcControllerBase
    {
        ...
        public ActionResult CheckLogin(string username, string password, string verifycode, string domainlogin)
        {
            ...
            #region 内部账户验证
            UserEntity userEntity = userBll.CheckLogin(username, password, domainlogin);
