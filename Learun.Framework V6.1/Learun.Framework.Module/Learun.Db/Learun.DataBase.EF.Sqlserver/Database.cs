...
namespace Learun.DataBase.SqlServer
{
    ...
    public class Database : IDatabase
    {
        ...
        {
            return dbcontext.Database.Connection.Query<T>(procName, null, dbTransaction, true, null, CommandType.StoredProcedure).FirstOrDefault();
        }
        /// <summary>
        /// 执行存储过程
        /// </summary>
        ...
        {
            return dbcontext.Database.Connection.Query<T>(procName, dbParameter, dbTransaction, true, null, CommandType.StoredProcedure).FirstOrDefault();
        }
